...
Auf manchen Datensätzen kommt die Größe der von \texttt{HeightFirstArea} und \texttt{HeightAdvantageArea} der von Sequitur erzeugten Grammatiken sehr nahe. So zum Beispiel auf den Datensätzen \emph{english} und \emph{xml}.
...
\begin{figure}
    ...
    \subfloat[Durchschnittslänge der Regeln]{
        \begin{tikzpicture}
            \begin{axis}[lengthplot, title={DNA Regellänge}]
    ...
    \caption{Die Ergebnisse für die Kompression des \emph{dna} Datensatzes aus dem Pizza\&Chili Corpus. Siehe \autoref{diagrams} für weitere Erläuterungen.}
    \label{resultsdna}
\end{figure}
...
\begin{figure}
    ...
    \caption{Die Ergebnisse für die Kompression des \emph{proteins} Datensatzes aus dem Pizza\&Chili Corpus. Siehe \autoref{diagrams} für weitere Erläuterungen.}
...
\begin{figure}
    ...
    \subfloat[Durchschnittslänge der Regeln]{
        \begin{tikzpicture}
            \begin{axis}[lengthplot, title={XML Regellänge}]
    ...
    \caption{Die Ergebnisse für die Kompression des \emph{xml} Datensatzes aus dem Pizza\&Chili Corpus. Siehe \autoref{diagrams} für weitere Erläuterungen.}
    \label{resultsxml}
\end{figure}
...
\begin{figure}
    ...
    \caption{Die Ergebnisse für die Kompression des \emph{english} Datensatzes aus dem Pizza\&Chili Corpus. Siehe \autoref{diagrams} für weitere Erläuterungen.}
