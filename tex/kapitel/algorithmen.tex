...
\begin{figure}
	\centering
	\subfloat[Die leere Anfangsdatenstruktur. Die Startregel $S$ ist noch leer.]{
        \parbox[c]{5cm}{
            \centering
            \begin{tikzpicture}[
                transform shape,
    ...
    \subfloat[$ab$ wurde durch das Nichtterminal $A$ ersetzt. Die $A$ besitzen einen Pointer auf das Guard-Symbol der Regel $A$.]{
        \begin{tikzpicture}[
            scale=.9, transform shape,
            normalnode/.style={rectangle, draw=black!60, thick, minimum size=5mm},
            guardnode/.style={diamond, draw=black!60, thick, minimum size=3mm},
