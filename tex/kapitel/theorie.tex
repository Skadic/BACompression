...
Die vorgestellten Intervalle erlauben es alle Suffixe mit einem gemeinsamen Präfix einer Länge von mindestens $\ell$ in einem String zu gruppieren.
