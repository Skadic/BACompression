...
/**
 * The class housing the functions necessary for computing the LZ77 Factorization of a string
 * Use the {@link #factorize(String)} function to compute a list of {@link LZFactor} objects,
 * or the {@link #lzFactorizedString(String)} function to get the result as a String.
 */
public class LZ {
     ...
     * @return The LZ77 Representation of the string as a list of LZ Factors
     */
    ...
    /**
     * Create a string representing the LZ77 Factorization of the given string
     * @param s A string to factorize
     * @return The LZ77 Representation of the string
     */
    public static String lzFactorizedString(String s) {
